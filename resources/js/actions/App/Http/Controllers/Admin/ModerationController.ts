...
/**
* @see \App\Http\Controllers\Admin\ModerationController::markCorrigendum
 * @see app/Http/Controllers/Admin/ModerationController.php:193
 * @route '/admin/moderation/{notice}/corrigendum'
 */
export const markCorrigendum = (args: { notice: string | { id: string } } | [notice: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: markCorrigendum.url(args, options),
    method: 'post',
})

markCorrigendum.definition = {
    methods: ["post"],
 ...
 * @route '/admin/moderation/{notice}/corrigendum'
 */
markCorrigendum.url = (args: { notice: string | { id: string } } | [notice: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { notice: args }
    }
    ...
    return markCorrigendum.definition.url
            .replace('{notice}', parsedArgs.notice.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/admin/moderation/{notice}/corrigendum'
 */
markCorrigendum.post = (args: { notice: string | { id: string } } | [notice: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: markCorrigendum.url(args, options),
    method: 'post',
})
 ...
 * @route '/admin/moderation/{notice}/corrigendum'
 */
    const markCorrigendumForm = (args: { notice: string | { id: string } } | [notice: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: markCorrigendum.url(args, options),
        method: 'post',
    })
 ...
 * @route '/admin/moderation/{notice}/corrigendum'
 */
        markCorrigendumForm.post = (args: { notice: string | { id: string } } | [notice: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: markCorrigendum.url(args, options),
            method: 'post',
        })
    
    markCorrigendum.form = markCorrigendumForm
/**
...
const ModerationController = { index, show, approve, reject, markCorrigendum, mergeDuplicate, update }
